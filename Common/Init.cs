...
namespace Tracer.Common
{
    public class Framebuffers
    {
        ...
        public static void SetupFBO(ref int framebufferTexture, Vector2i viewportSize)
        {
            // Color Texture
        ...
        public static void ResizeFBO(Vector2i viewportSize, ref int frameBufferTexture)
        {            
            //Resize framebuffer
            GL.BindTexture(TextureTarget.Texture2D, frameBufferTexture);
            GL.TexImage2D(TextureTarget.Texture2D, 0, PixelInternalFormat.Rgba32f, viewportSize.X, viewportSize.Y, 0, PixelFormat.Rgba, PixelType.UnsignedByte, IntPtr.Zero);
        ...
        public static void RenderFramebuffer(ref Shader FBOshader, int framebufferTexture)
        {
            FBOshader.Use();
